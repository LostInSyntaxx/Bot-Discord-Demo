...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-[#242424] border border-[#2f2f2f]">
        <CardBody className="flex flex-col items-center gap-6 p-8">
          ...
          <div className="text-center">
            ...
            <p className="text-zinc-400">
              Manage your bot with ease and control
            </p>
          </div>

          <Button
            onPress={handleLogin}
            className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold py-6"
